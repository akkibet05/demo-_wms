...
router.post("/view/add_sales", auth, async (req, res) => {
    try {
        const { invoice, date, warehouse_name, product_name, stock, quantity, note, room, primary_code, secondary_code, prod_code, level, isle, pallet, batch_code, SCRN,expiry_date,PO_number, ReqBy, dateofreq,typeservices, destination, deliverydate, driver, plate, van, DRSI, typevehicle, TSU, TFU  } = req.body
